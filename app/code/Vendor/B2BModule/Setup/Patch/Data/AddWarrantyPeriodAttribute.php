 ...
 */
class AddWarrantyPeriodAttribute implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    public function apply(): void
    {
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'note' => 'Enter warranty period (e.g., "12 months", "2 years")'
            ]
        );
    ...
    public function revert(): void
    {
        /** @var EavSetup $eavSetup */
        $eavSetup = $this->eavSetupFactory->create(['setup' => $this->moduleDataSetup]);
        $eavSetup->removeAttribute(Product::ENTITY, 'warranty_period');
    }
